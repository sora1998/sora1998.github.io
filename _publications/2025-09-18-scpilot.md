...
authors:
  ...
  - Zhiting Hu
  - Eric P. Xing
paperurl: "https://openreview.net/forum?id=<your-scpilot-id>"  # replace with actual link
...
tags: [LLMs, Scientific Reasoning, Single-cell, Bioinformatics, Automation of Science]
selected: true
---
...
**Links.**  
- [Paper (OpenReview)](https://openreview.net/forum?id=<your-scpilot-id>)
